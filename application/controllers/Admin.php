...
class Admin extends CI_Controller {
    ...
    //     $data['banner_desc'] = $this->Banner_model->getDesc($b_id);
    ...
    //         $this->security->get_csrf_token_name(); 
    //         $this->security->get_csrf_hash();
    //         $bn_name = $this->security->xss_clean($this->input->post('name', TRUE));
    //         $bn_id = $this->security->xss_clean($this->input->post('banner_id', TRUE));
    ...
    //                 window.location.href='".base_url("Admin/banner_edit/".$bn_id)."';
    //             </script>";
    //         }
    //     }
    //     else{
