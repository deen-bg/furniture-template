		          	...
		          	<div class="panel">
			            ...
			            <div class="panel-body container-fluid">
							  ...
							  <div class="form-group form-material" data-plugin="formMaterial">
								...
								<input type="text" class="form-control" id="name" name="name" value="<?=$banner_desc[0]['name']; ?>" required>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									...
									<div id="width"></div>
									  ...
									  data-default-file="<?=base_url('./assets/images/banner/'. $banner_desc[0]['img_cover']);?>" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"/>
				                ...
				                <div class="text-right">
				                	<input type="hidden" name="banner_id" value="<?=$banner_desc[0]['id']; ?>">
