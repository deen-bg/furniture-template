			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = '<?=base_url('Admin/edit_banner/'.$val_item['id']);?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
