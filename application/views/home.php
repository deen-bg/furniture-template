...
<head>
    ...
    <link href="<?=base_url('assets/css/jquery.nice-number.min.css');?>" rel="stylesheet">

    <link href="<?=base_url('assets/css/style.css.map');?>" rel="stylesheet">
...
<body>
                        ...
                        <div class="row no-gutters align-items-center ">
                            <div class="col-lg-4 col-md-5">
                                <div class="slider-product-image d-none d-md-block">
                                    <img src="<?=base_url('assets/images/slider/1.jpg')?>" alt="Slider">
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="<?=base_url('assets/images/slider/3.jpg')?>" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>-20% <br> OFF</p>
                                        </div>
                                    </div> <!-- slider product image -->
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="<?=base_url('assets/images/slider/2.jpg')?>" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>FREE<br> QUOTE</p>
                                        </div>
                                    </div> <!-- slider product image -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="<?=base_url('assets/images/discount-product/product-1.jpg')?>" alt="Product">
                        </div> <!-- product image -->
                ...
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="<?=base_url('assets/images/discount-product/product-2.jpg')?>" alt="Product">
                        </div> <!-- product image -->
                        <div class="product-content">
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="<?=base_url('assets/images/product/p-1.jpg')?>" alt="Product"></a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="<?=base_url('assets/images/product/p-2.jpg')?>" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-20%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="<?=base_url('assets/images/product/p-3.jpg')?>" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-10%</p>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-left mt-45">
                        <div class="services">
                            <img src="<?=base_url('assets/images/services/services.jpg')?>" alt="">
                ...
                <div class="col-lg-12">
                    <div class="showcase-active mt-65">
                        <div class="single-showcase">
                            <img src="<?=base_url('assets/images/showcase/t-1.jpg')?>" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                        <div class="single-showcase">
                            <img src="<?=base_url('assets/images/showcase/t-2.jpg')?>" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                    </div> <!-- showcase active -->
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="<?=base_url('assets/images/team/t-1.jpg')?>"
                             alt="Team">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="<?=base_url('assets/images/team/t-2.jpg')?>"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="<?=base_url('assets/images/team/t-3.jpg')?>"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="<?=base_url('assets/images/team/t-4.jpg')?>"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="<?=base_url('assets/images/blog/b-1.jpg')?>" alt="Blog">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="meta d-flex justify-content-between align-items-center">
                                <div class="meta-admin d-flex align-items-center">
                                    <div class="image">
                                        <a href="#"><img src="<?=base_url('assets/images/blog/admin.jpg')?>" alt="Admin"></a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="<?=base_url('assets/images/blog/b-2.jpg')?>" alt="Blog">
                        </div>
                        <div class="blog-content">
                            <div class="content">
                                <h4 class="title"><a href="#">Rowan an orangutan known  & loved</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="<?=base_url('assets/images/blog/b-3.jpg')?>" alt="Blog">
                        </div>
                        <div class="blog-content">
                            <div class="content">
                                <h4 class="title"><a href="#">Rowan an orangutan known  & loved</a></h4>
    ...
    <!--====== Nice Number js ======-->
    <script src="<?=base_url('assets/js/jquery.nice-number.min.js');?>"></script>
